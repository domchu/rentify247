...
<div class="lg:w-[90%] flex lg:h-[90%] md:h-[90%]  overflow-hidden relative w-[90%]">
    ...
    <?php $__currentLoopData = $slideArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="slide w-full h-full shrink-0 relative overflow-hidden transition-opacity duration-500 opacity-0 ease-in first:opacity-100 first:relative">
        <img class="w-full h-full object-cover object-center overflow-hidden" src="<?php echo e($slide['image']); ?>">
    </div>
    <div class=" absolute flex w-full h-full items-center justify-center text-center">
        <h1 class="content p-4 md:p-8 text-sm md:text-4xl lg:text-5xl text-blue-500 font-bold bg-grey-200/20 backdrop-blur-sm transition-opacity duration-500 ease-in-out opacity-0"><?php echo e($slide['description']); ?></h1>
    </div>
...
<?php /**PATH C:\Users\LENOVO\Downloads\Desktop\rentify247\rentify247\resources\views/components/slider.blade.php ENDPATH**/ ?>