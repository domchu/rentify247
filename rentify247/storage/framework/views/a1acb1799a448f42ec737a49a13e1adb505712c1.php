        ...
        <nav class="bg-gradient-to-br from-[--primary-clr-2] to-[--primary-clr-1] w-full sm:w-1/5 sm:pl-2 lg:pl-14 pr-5 py-5 pb-5 sm:pb-28">
            ...
            <img id="dropdown-btn" src="../../assets/icon-arrow.svg" class="w-4 h-5 pt-2 invert brightness-0">
                ...
                <div id="dropdown-menu" class="hidden sm:hidden pt-2 pl-4">
                    <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $questions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="py-1 pl-2 sm:pl-0"><a href="#" class="faq-link text-white text-base hover:text-gray-200" data-category="<?php echo e($category); ?>"><?php echo e($category); ?></a></li>
...
<script>
    const faqs = <?php echo json_encode($faqs, 15, 512) ?>
</script>

<script src="<?php echo e(asset('js/faqsection.js')); ?>" defer></script>

<?php /**PATH C:\Users\LENOVO\Downloads\Desktop\rentify247\rentify247\resources\views/components/faq-section.blade.php ENDPATH**/ ?>