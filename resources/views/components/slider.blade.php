<div class="w-full lg:h-[70vh] md:h-[50vh] h-[40vh] flex justify-center items-center relative">
    ...
    <div class="h-full lg:w-[90%] flex lg:h-[90%] md:h-[90%]  overflow-hidden relative w-[90%]">
        ...
        @foreach ($slideArray as $slide)
            ...
            <div class=" absolute flex w-full h-full items-center justify-center text-center">
                <h1
                    class="content p-4 md:p-8 text-sm md:text-4xl lg:text-5xl text-blue-500 font-bold bg-grey-200/20 backdrop-blur-sm transition-opacity duration-500 ease-in-out opacity-0">
