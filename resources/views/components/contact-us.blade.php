    ...
    <div>
        <div class="my-12">
            <div class="contact-title max-w-full  bg-sky-800 text-center py-12">
                ...
                <p class="text-white px-7 pb-4 text-wrap md:w-4/5 md:mx-auto md:my-0 lg:w-3/6 lg:mx-auto lg:my-0"><span
                        class="text-[#dc2d2d] font-bold text-xl px-1">Need an expert?</span> You are more than welcome to
                    leave your contact information and we will be in touch shortly.</p>
