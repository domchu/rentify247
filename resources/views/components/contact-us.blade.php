<section>
    <div>
        ...
        {{-- ADDRESS SECTION --}}
        <div
            class="flex flex-wrap md:flex md:flex-wrap lg:flex-nowrap md:justify-center md:w-4/6 lg:w-5/6 md:mx-auto md:my-20 lg:my-32">
        ...
        {{-- FOLLOW US --}}
            <div
                class="flex flex-col justify-center items-center pt-8 md:flex md:justify-center md:items-center md:flex-col lg:my-20">
